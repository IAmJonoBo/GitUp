...
const Wizard = React.lazy(() =>
  import("./components/wizard/Wizard").then((module) => ({
    default: module.Wizard,
  })),
);
const Presets = React.lazy(() =>
  import("./components/app/Presets").then((module) => ({
    default: module.Presets,
  })),
);
const Glossary = React.lazy(() =>
  import("./components/app/Glossary").then((module) => ({
    default: module.Glossary,
  })),
);
const Settings = React.lazy(() =>
  import("./components/app/Settings").then((module) => ({
    default: module.Settings,
  })),
);
const Export = React.lazy(() =>
  import("./components/app/Export").then((module) => ({
    default: module.Export,
  })),
);
const RepoTree = React.lazy(() =>
  import("./components/preview/RepoTree").then((module) => ({
    default: module.RepoTree,
  })),
);
const WorkflowGraph = React.lazy(() =>
  import("./components/preview/WorkflowGraph").then((module) => ({
    default: module.WorkflowGraph,
  })),
);
const PostureChart = React.lazy(() =>
  import("./components/preview/Charts").then((module) => ({
    default: module.PostureChart,
  })),
);
const MaintenanceForecast = React.lazy(() =>
  import("./components/preview/Charts").then((module) => ({
      ...
      {showOverlay && (
        ...
        >
          ...
          >
            ...
            <div
              ref={scrollRef}
              className="space-y-1 overflow-y-auto font-mono text-sm leading-relaxed scrollbar-thin flex-1 min-h-0 pr-2"
            >
              ...
              {isSimulating && (
                <div className="animate-pulse text-zinc-500 ml-6">_</div>
              )}
            </div>
            ...
            {!isSimulating && (
              <div className="mt-6 pt-4 border-t border-emerald-500/20 flex justify-between items-center shrink-0">
                ...
                <div className="flex gap-3">
                  ...
                  <Button
                    onClick={reset}
                    className="bg-emerald-900/50 text-emerald-300 border border-emerald-500/50 hover:bg-emerald-900 hover:shadow-[0_0_20px_rgba(16,185,129,0.4)]"
                  >
                    Close
                  </Button>
                </div>
...
const PreviewPane = ({ className }: { className?: string }) => (
  <div
    className={cn(
      "bg-[#0B0F19] p-6 overflow-y-auto space-y-6 scrollbar-thin shadow-inner h-full",
      className,
    )}
  >
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-500 hidden sm:block">
                  Configure your repository defaults
                </p>
              </div>
            </div>
              ...
              {currentView === "wizard" && (
                <>
                  ...
                  <Button
                    size="sm"
                    variant="outline"
                    className="border-zinc-700 text-zinc-300 hover:bg-zinc-800 hidden sm:inline-flex"
                    onClick={reset}
                  >
                    Reset
                  </Button>
