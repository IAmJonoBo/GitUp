...
export interface RepoPackResolution {
...
export type DesignSpecPatch = DeepPartial<DesignSpec>;

export type PlanConfig = DesignSpec;
export type PlanConfigPatch = DesignSpecPatch;
