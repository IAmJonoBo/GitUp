...
export const PRESET_BUNDLES: PresetBundle[] = [
  ...
  },
  {
    ...
    packs: [
      "pack.quality.lint-eslint",
      "pack.quality.format-prettier",
      "pack.quality.test-vitest",
    ],
    config: {
      visibility: "private",
  ...
  },
  {
    ...
    description:
      "Opinionated Next.js stack with testing and deploy-ready defaults.",
    packs: [
      "pack.runtime.framework",
      "pack.quality.lint-eslint",
      "pack.quality.format-prettier",
      "pack.quality.test-vitest",
    ],
