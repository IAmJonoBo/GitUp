...
export const LICENSES = ["MIT", "Apache-2.0", "GPL-3.0", "BSD-3-Clause", "Unlicense", "None"];
...
export const TECH_OPTIONS: TechStackOption[] = [
  // Frontend Frameworks
  {
    ...
    recommendedFor: [Language.TYPESCRIPT, Language.JAVASCRIPT],
    tags: ["Popular", "UI"],
  },
  {
    id: "vue",
  ...
  },
  {
    ...
    recommendedFor: [Language.PYTHON],
    tags: ["Fast", "Async"],
  },
  {
    id: "gin",
    ...
    category: "backend",
    iconClass: "devicon-go-original",
    recommendedFor: [Language.GO],
    tags: ["Fast"],
  },
  {
    id: "actix",
    name: "Actix",
    description: "Powerful actor-based framework",
    category: "backend",
    iconClass: "devicon-rust-plain",
    recommendedFor: [Language.RUST],
    tags: ["Performance"],
  },
  ...
  },
  {
    ...
    category: "devtools",
    iconClass: "devicon-eslint-original",
    recommendedFor: [Language.TYPESCRIPT, Language.JAVASCRIPT],
    tags: ["Quality"],
  },
  {
