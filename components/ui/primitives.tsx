...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      default:
        "bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_0_10px_rgba(167,139,250,0.3)]",
      ...
      cyber:
        "bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-500 text-white shadow-[0_0_15px_rgba(168,85,247,0.5)] hover:shadow-[0_0_25px_rgba(168,85,247,0.7)] hover:scale-[1.02]",
    };
    const sizes = {
...
export const Badge = ({
  ...
  variant?: "default" | "secondary" | "outline" | "success" | "cyber";
}) => {
  const variants = {
    default:
    ...
    success:
      "border-transparent bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 shadow-[0_0_10px_rgba(52,211,153,0.2)]",
    cyber:
      "border-transparent bg-gradient-to-r from-pink-500/20 to-purple-500/20 text-purple-200 border border-purple-500/30",
  };
  return (
    <div
      className={cn(
