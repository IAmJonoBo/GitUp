    ...
    return (
        <div className="max-w-3xl mx-auto py-10 px-6 animate-in slide-in-from-bottom-4 duration-500">
            <div className="mb-10">
                ...
                <p className="text-zinc-400">Customize your bootstrapping experience.</p>
            </div>
            ...
            <div className="space-y-8">
                            ...
                            return (
                                <div
                                    ...
                                    className={cn(
                                        ...
                                        isSelected ? "bg-zinc-800 border-purple-500 text-purple-200" : "bg-zinc-900/50 border-white/5 text-zinc-500 hover:bg-zinc-900 hover:text-zinc-300",
                ...
                <section>
                    <h3 className="text-sm font-bold text-zinc-500 uppercase tracking-wider mb-4">Accessibility</h3>
                    <Card className="p-6 bg-zinc-900/50 border-white/5">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h4 className="text-base font-semibold text-zinc-200">Reduced Motion</h4>
                                    <p className="text-sm text-zinc-500 mt-1">Minimize animations throughout the application.</p>
                                </div>
                            </div>
                ...
                <section>
                    <h3 className="text-sm font-bold text-zinc-500 uppercase tracking-wider mb-4">Defaults</h3>
                    <Card className="p-6 bg-zinc-900/50 border-white/5 opacity-60">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h4 className="text-base font-semibold text-zinc-200">User Preferences</h4>
                                <p className="text-sm text-zinc-500 mt-1">Author name and email persistence coming soon.</p>
                            </div>
                        </div>
                    </Card>
                </section>
