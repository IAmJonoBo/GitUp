      ...
      <Card className="bg-zinc-900 border border-amber-500/20 shadow-[0_0_15px_rgba(245,158,11,0.05)] overflow-hidden">
        ...
        <CardContent className="pt-6">
          <div className="space-y-4">
            <div>
              <h4 className="text-sm uppercase tracking-wider text-zinc-500 font-semibold mb-1">Why {decision.recommendation}?</h4>
              <p className="text-sm text-zinc-300 leading-relaxed">{decision.why}</p>
            </div>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <motion.div 
                    className="bg-zinc-950/50 p-3 rounded-lg border border-white/5"
                    whileHover={{ scale: 1.02, borderColor: "rgba(244, 63, 94, 0.3)", backgroundColor: "rgba(244, 63, 94, 0.05)" }}
                ...
                <motion.div 
                    className="bg-zinc-950/50 p-3 rounded-lg border border-white/5"
                    whileHover={{ scale: 1.02, borderColor: "rgba(34, 211, 238, 0.3)", backgroundColor: "rgba(34, 211, 238, 0.05)" }}
                    transition={{ type: "spring", stiffness: 300, damping: 20 }}
                >
                    ...
                    <div className="flex flex-wrap gap-2">
                        {decision.alternatives.map((a, i) => (
                            <motion.span 
                                ...
                                whileHover={{ scale: 1.05, backgroundColor: "#27272a", borderColor: "#22d3ee", color: "#22d3ee" }}
                                layout
                            >
                                {a}
                            </motion.span>
